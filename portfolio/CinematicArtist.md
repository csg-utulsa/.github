...
> 
> -   **Storyboards / Animatics** (planned shots + pacing before 3D)
> -   **Sequencer/Timeline Cinematics** (30–60 second in-engine sequences)
> -   **Camera Direction Proof** (shot composition, lens choices, camera movement)
> -   **Environmental Motion + VFX** (timed props, particles, lighting changes)
> -   **Gameplay-to-Cinematic Integration** (triggered sequences + transitions)
> -   **Audio + Timing Sync** (cuts, motion, and events aligned to sound/music)
...
### A) Presentation
- [ ]  🌟 **Final Cinematic Clip:** 30–60 seconds rendered directly from in-game footage.
- [ ]  🌟 **Gameplay-to-Cinematic Clip:** Player control → cinematic → back to control.
- [ ]  **Cinematic Overview:** 1–2 shots or a short clip showing the full scene setup.
- [ ]  **Shot Variety Proof:** At least 3 distinct shots (wide / medium/close).
- [ ]  **Readable Captions:** Your role + tools used (Timeline/Sequencer, cameras, etc.).
...
### D) Sequencer / Timeline Proof
- [ ]  **Sequencer Screenshot:** Timeline view showing organized tracks (camera, animation, audio, FX).
- [ ]  **Camera Keyframe Proof:** Clear easing and intentional camera motion (not linear/robotic).
- [ ]  **Event Timing Proof:** Markers or triggers showing when key moments hit.
...
- [ ] **Secondary Motion:** Animated props timed to the sequence (doors, debris, cloth, etc.).
- [ ] **VFX Sync:** Particle effects triggered on timeline events (dust, sparks, rain, explosions).
- [ ] **Dynamic Lighting:** Lighting changes during the scene (flicker, alarms, sunset shift, etc.).

### G) Audio + Polish
- [ ]  **Audio Sync Proof:** Cuts or motion landing on a beat, sound effect, or dialogue moment.
- [ ]   **Post-Processing Proof:** Raw vs graded comparison (DOF, bloom, LUT, etc.).
